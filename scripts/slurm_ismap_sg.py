...
def parse_args():
    ...
    # SLURM options
    parser.add_argument('--walltime', type=str, required=False, help='Amount of wall time. Default 40 minutes', default='0-00:40:00')
    ...
    parser.add_argument('--queries', nargs='+', type=str, required=True, help='Path to IS queries.')
...
def main():
    ...
    # Get read pairs and their corresponding assemblies
    # if required
    fileSets = read_file_sets(args)
    print fileSets
    unused_fileSets = []

    args.queries = ' '.join(args.queries)
